...
Now that we are ready with the environment, we need to create a file called config.py which will contain the constants like the adress of the organizations we will be searching for in Github and also the TOKEN to use the Github API.
